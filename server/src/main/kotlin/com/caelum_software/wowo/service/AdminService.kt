...
class AdminService(
    ...
    suspend fun insertWord(words: List<String>, language: String, category: String, difficulty: Int): IsSuccess {
        return wordRepository.addWord(words, category, language, difficulty)
    }
